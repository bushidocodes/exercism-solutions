                                ...
                                size_t base_list_element_count)
{
    ...
    {
        base_is_larger = list_to_compare_element_count < base_list_element_count;
    }

    size_t larger_count = base_is_larger ? base_list_element_count : list_to_compare_element_count;
    int *larger = base_is_larger ? base_list : list_to_compare;
    size_t smaller_count = base_is_larger ? list_to_compare_element_count : base_list_element_count;
