...
Robot::Robot(position_t position, enum Bearing bearing)
    : position{position}, bearing{bearing} {}
const position_t Robot::get_position() const { return position; }

enum Bearing Robot::get_bearing() const { return bearing; }
